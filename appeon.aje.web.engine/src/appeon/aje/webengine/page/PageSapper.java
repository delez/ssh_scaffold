 ...
 * 
 */
package appeon.aje.webengine.page;
 ...
 */
public class PageSapper extends Sapper {
	/**
	 * @param ctx
	 */
	public PageSapper(Context ctx) {
		super(ctx);
	...
	private void process(Model model) throws IOException {
		...
		outTemplate("jsp_edit.vm", model, "edit.jsp");
		outTemplate("jsp_show.vm", model, "show.jsp");
		outTemplate("jsp_list.vm", model, "list.jsp");
		outTemplate("jsp_new.vm", model, "new.jsp");
